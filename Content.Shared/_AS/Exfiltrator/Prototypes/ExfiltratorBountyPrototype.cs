...
namespace Content.Shared._AS.Exfiltrator.Prototypes;

/// <summary>
/// This is a prototype for a exfiltrator bounty, a set of items
/// that must be sold together in a labeled container in order
/// to receive a reward in doubloons.
/// </summary>
[Prototype, Serializable, NetSerializable]
public sealed partial class ExfiltratorBountyPrototype : IPrototype
{
    /// <inheritdoc/>
    [IdDataField]
    ...
    /// </summary>
    [DataField(required: true)]
    public List<ExfiltratorBountyItemEntry> Entries = new();
    ...
    /// </summary>
    [DataField]
    public string IdPrefix = "EXF-";
}

[DataDefinition, Serializable, NetSerializable]
public readonly partial record struct ExfiltratorBountyItemEntry()
{
    /// <summary>
    /// An internal ID for matching, should be used in ExfiltratorBountyItemComponent
    /// </summary>
    [IdDataField]
