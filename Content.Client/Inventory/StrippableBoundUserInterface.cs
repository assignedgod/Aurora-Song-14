...
namespace Content.Client.Inventory
{
    ...
    public sealed class StrippableBoundUserInterface : BoundUserInterface
    {
        ...
        private void AddHandButton(Entity<HandsComponent> ent, string handId, Hand hand)
        {
            ...
            // Possibly remove lines 201 and 202, need to see how our current interfaces react with it being present | Aurora Song
        ...
        private void AddInventoryButton(EntityUid invUid, string slotId, InventoryComponent inv)
        {
            ...
            // possibly remove these four lines too, not sure why but will observe | Aurora SOng
