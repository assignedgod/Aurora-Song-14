...
public sealed partial class AnomalyGeneratorComponent : Component
{
    ...
    public string RequiredMaterial = "Bananium"; // Aurora Song: Plasma>Bannanium

    /// <summary>
    /// The amount of material needed to generate a single anomaly
    /// </summary>
    [DataField("materialPerAnomaly"), ViewVariables(VVAccess.ReadWrite)]
    public int MaterialPerAnomaly = 1000; // Aurora Song: 1500>1000
    ...
    public ProtoId<StackPrototype> RefundStackType = "Bananium"; //Aurora song: Anomalite > Bannanium

    /// <summary>
    /// Stack count to return on refund
    /// </summary>
    [DataField, ViewVariables(VVAccess.ReadWrite)]
    public int RefundAmount = 10; // Aurora Song: 3>10
    // End Frontier
}
